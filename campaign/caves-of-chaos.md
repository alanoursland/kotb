...
## Easy integrations — *live by their own labor*
...
- **Leader:** [Karrgan](../characters/faction-leaders.md#hobgoblin-chief--karrgan) — the peer-commander where the captive economy and integration risk both live. The most important chief.
- **Challenge:** the cannibalism is famine-driven but has become institutional policy: scheduled banquets, a torture chamber used as larder, and status attached to distribution. Trade can dissolve it—a prisoner is worth more **alive and exchanged** than eaten—but the change must preserve Karrgan's public authority and must not reward taking replacements. The food-for-prisoners agreement is the campaign's humanitarian pilot program, and it works.
...
- **Playable negotiation:** [Faction Negotiations](faction-negotiations.md#karrgans-hobgoblingoblin-bloc). **Full economic logic:** [Captivity & Hunger](captivity-and-hunger.md).
...
- **The payment chain:** the Black Eagle Barony pays the bugbears for slaves in **Eagles**, gold-washed lead scrip. Its representatives bring trade goods on collection visits and accept Eagles, but charge the bugbears vastly inflated prices. The bugbears therefore treat Eagles as gold and use them to pay [Brundt](../characters/brundt-the-ogre.md) for muscle. He has no access to their Barony trade channel, so his sack only grows. His hoard and the bugbear pay sacks are two ends of the same trail.
