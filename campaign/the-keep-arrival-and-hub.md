...
## Part 1 — First arrival (the scene)

The party presents the **[Duke's letter of authority](audience-with-duke-stefan.md)** at the gate; it gets them past the garrison and in front of the Castellan. The letter buys *access.* It does not buy *belief.*
...
## Part 2 — The Keep as hub (the debrief loop)

From here on, the Keep is home base, and **every return runs through Valerian.** The party is escorted to him first thing to **report and debrief.** This isn't an interrogation — it's a commander doing his job: he wants to know what's happening on his frontier, and he'll **offer what support he can** (supplies, a few men, healing from the chapel, information).
...
## Part 3 — Valerian's missions (the side-board)

Valerian *requests help,* and his requests are **traditional-D&D-coded** — concrete threats, clean objectives, rewards. They serve his sensibilities (he understands a monster to kill better than a peace to broker), they build his trust when completed, and they **distract from the Duke's mission.** That tension is the point: indulging him earns the political track; chasing every job burns the time the caves don't have.

| Mission | As Valerian frames it | What it really is |
|---|---|---|
| **The swamp lizardmen & the lost necklace** | **Niko Voss** returned late from fishing after his mother **Maren** had gone searching into the marsh. She came back unharmed but missing one of her two necklaces. Hadrian reported the theft; recover the necklace and determine whether the swamp people threaten the Keep — **reward** on return. | A **misread toll, not an attack** — the campaign's whole thesis in miniature. See [The Lizardfolk of the Marsh](the-lizardfolk-of-the-marsh.md) and the live [Southern Forest route](../locations/southern_forest/index.md). |
| **The bandits** | Raiders hitting travelers; the Castellan knows little and lumps "human and monster raids" together. | The label-lie at Keep scale: a *human* [bandit camp](the-bandit-camp.md) nobody calls "monsters" — the thesis in reverse. Their live approach and resolution are in the [Southern Forest](../locations/southern_forest/index.md). |
...
- **What the Keep knows:** lizard people live somewhere in the swamp. There have been scattered sightings, but no reliable count, mapped settlement, shared language, known leader, or understanding of their customs. Maren's report is the first recent incident substantial enough for Valerian to place on his list of local problems.
- Niko Voss went fishing and failed to return when expected. Maren followed his usual channels into the marsh to find him. Niko returned safely by a different channel after she had gone; Maren crossed a boundary she could not recognize and encountered the lizardfolk.
- The marsh lizardfolk (per [the decision](../narrative/progression.md), a **reptilian offshoot of kobold**, under the matriarch **[Sessrik](../characters/faction-leaders.md#lizardfolk-leader--sessrik-the-marsh-matriarch)**) **aren't raiders** — well-fed, territorial, they ask only to be left alone. They took one of Maren's two necklaces as a **passage toll** and let her go unharmed. "Robbery" is the human reading of a transaction neither side could explain.
...
- **The family:** **Hadrian Voss** is the Guild's contracted gem and precious-metal appraiser at the frontier as well as a wealthy independent dealer. **Maren** is his wife and business partner; **Niko**, their fifteen-year-old son, can show the party his fishing route and where he left it. Convincing Maren to pay the "monsters" who took her mother's necklace is the thesis argued to one wronged person before it is ever argued in the Duke's hall.
...
### The bandits and the missing distinction
Valerian framing **both** bandits and cave-attacks as "attacks," knowing little and not distinguishing the two, is the [overview's lie-in-the-words](../overview.md) at the Keep level: the human raiders are the same behavior as the caves with none of the "monster" label attached. When the party discovers the [bandit camp](the-bandit-camp.md) is *human* — starving under the same famine, led by the very soldier who lost [Khaeros](../characters/khaeros-the-minotaur.md) — and that nobody at the Keep called *them* monsters, that's the realization the whole campaign is built to produce, run in reverse. Full treatment: **[The Bandit Camp](the-bandit-camp.md).**

---

## DM notes (player challenges & opportunities)

- **Winning Valerian is a campaign-length arc, not a scene.** First arrival gets provisional cooperation; the debrief loop is where belief is earned, result by result. Don't let one good speech "solve" him — make the players *show* him.
- **The missions are a real choice with real costs.** Each builds his trust (good for beat 7) and burns time (bad for the caves, where the famine grinds on). Let the party feel the trade. A party that does *every* Keep job is well-liked and behind.
- **The lizardmen are the tell.** If you want to know early whether your table gets the campaign, watch what they do in the swamp. It's the whole game in one quest, with a necklace as the stakes.
- **Hold the undead camouflage.** The single most important "don't flag it" on this page. Its later payoff depends on being ignored now.

## Canon notes
- **Canonical:** the swamp lizardmen lair, the mad hermit, the bandit camp — all B2 wilderness. Wild Traladar as a **gothic** region (undead unremarkable) is consistent with Mystara's Karameikos.
- **Campaign connective tissue:** B2 separately gives the Keep jewel merchant's wife a 1,200-gp necklace and the largest lizard man a 1,100-gp necklace. The Voss incident joins those details; Niko, Maren's search, the report to Valerian, and the passage-toll interpretation are original to this campaign.

## Links
- Spine: [Narrative → Progression, beat 2](../narrative/progression.md)
- The NPC: [Castellan Valerian](../characters/castellan-valerian.md) · the other power of the Keep: [Father Branislav](../characters/the-curate.md)
- Where the party just came from: [The Audience with Duke Stefan](audience-with-duke-stefan.md)
- The missions as optional threads: [Progression → Optional threads](../narrative/progression.md)
- The clue Valerian buries: [The Iron Ring](the-iron-ring.md) (the manufactured famine)
