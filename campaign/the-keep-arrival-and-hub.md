...
Valerian framing **both** bandits and cave-attacks as "attacks," possibly without knowing they're two different groups, is the [overview's lie-in-the-words](../overview.md) at the Keep level: the human raiders are the same behavior as the caves with none of the "monster" label attached. When the party discovers the bandit camp is *human* — and that nobody at the Keep called *them* monsters — that's the realization the whole campaign is built to produce, rehearsed before the caves even resolve.
