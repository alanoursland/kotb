...
**Zone:** fortress roofline | **Access:** garrison only | **Primary use:** protection of the fortress corners

> Two square towers rise forty feet at the outer corners of the fortress. Battlements and arrow slits cover the northern approaches and the wall walks leading toward the Keep's larger towers.

## Run this area

- Each tower houses fortress soldiers and supports the central tower garrisons.
- Arrow slits protect the eastern and western corners of the main building.
- These are defensive posts with little reason for an unescorted visitor to enter.
- During an alarm, soldiers use the towers to keep attackers away from the fortress roof and upper chambers.
...
These are the same sixteen fortress guards listed in [area 24](24-keep-fortress.md), not a second unit. The roofline section normally occupies the firing positions while the interior section rests in the tower rooms or covers the stairs.

## Exits

- [Descend into the Keep Fortress](24-keep-fortress.md) - Take the guarded stair to the main building.
- [Go inward to the Central Towers](26-central-towers.md) - Cross the protected roof passage.
- [Follow the western battlement toward the Great Tower](23-great-tower.md) - Use the northern wall walk; garrison only.
- [Follow the eastern battlement toward the Cavalry Stables](22-cavalry-stables.md) - Use the northern wall walk; garrison only.
