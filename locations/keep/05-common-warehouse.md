...
**Zone:** southeastern outer bailey | **Access:** controlled commercial | **Primary use:** secured visitor cargo and supply handling

> A defensible, flat-roofed warehouse stands south of the stable. Its double doors are chained and padlocked. Through the gaps are glimpses of wagons, bales, barrels, boxes, and hanging inventory tags.

## Run this area

- Visitors with more goods than they can carry must store them here.
...
- Deposit or retrieve cargo under watch.
- Inspect seals, manifests, or signs of tampering.
...
- [Go west to the Smithy](08-smithy-and-armorer.md) - Cross into the shop quarter beside the forge.
- [Go northwest to the Guild House](16-guild-house.md) - Follow the trade-post signs across the bailey.
- [Go south to the Bailiff's Tower](06-bailiffs-tower.md) - Follow the wall to request administrative intervention.

## DM-only

This is where the campaign's political economy becomes physical: grain, wagons, guards, schedules, ownership, and authority. The challenge is building a sanctioned route outward, not finding food inside the Keep.
