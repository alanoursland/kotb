...
The campaign's core narrative as a sequence of goals with leeway around each — a critical-path spine the players advance along, surrounded by optional threads and multiple valid approaches.

> **Status:** spine established from the big-picture pass. Beats link out to scenes/rosters where those pages exist. Open decisions are flagged at the bottom — those are yours to make, not mine to invent.

## Design vocabulary

- **Beat** — a discrete goal or situation on the critical path.
- **Gate** — what must be true to move to the next beat. *Soft* = the story nudges; *hard* = it literally can't proceed until X. Prefer soft; reserve hard for genuine turning points.
- **Approach** — a distinct valid way through a beat (sword, gold, truth, alliance, food). Every beat wants at least two. **This is the leeway.**
- **Thread** — optional content branching off a beat. Skippable without breaking the spine, but it changes texture and the approaches downstream.
- **Curdle** — a victory that reveals a complication on a delay. A scripted consequence that turns a clean win into a deeper problem.

---

## The shape: two tracks over a hidden engine
...
### The hidden engine (DM eyes — the truth nobody on stage knows)

- A **cult of Thanatos** (Immortal of Entropy) hides in the Shrine at the back of the ravine. They present as **Traladaran liberators** fighting the colonizer Duke — and that grievance is *real;* Stefan is a colonizer. But the cult is older than the grievance and using it as a costume.
- The cult sends **undead out at night to destroy the caves' food** — killing herd animals, spoiling stores. The caves are starving, so they **raid travelers to survive.** *Hungry is the whole explanation for the raids.*
- **No one in the caves knows** the famine is manufactured. They blame the humans, the land, each other. The misdiagnosis *is* the corruption working.
...
Political beats and cave beats interleave; the numbering is rough sequence, not a rigid order.

### 1 — The Commission · *political* · **developed**
The Duke points the party at the caves: open relations, or clear them out. → **[The Audience with Duke Stefan](../campaign/audience-with-duke-stefan.md)**
...
### 4 — Walking the Caves · *caves* · **the leeway core**
The wide, exploratory heart. Meet the polities, discover the working détente, and live the campaign's thesis hands-on. → **roster: [The Caves of Chaos](../campaign/caves-of-chaos.md)** · framed by **[Brundt's Briefing](../campaign/brundts-briefing.md)** (real intel with two deliberate blanks — the bugbear pipeline and the cult — that the party may over-trust).
...
- **[Khaeros the minotaur](../characters/khaeros-the-minotaur.md)** lairs here—an escaped Black Eagle slave who just wants to go home free, and the hardest single negotiation in the ravine. He is also the witness who turns rumor about the Baron into an investigation. *Befriending him and building the first case against the Baron are the same quest.* Reach him only through Brundt → **[First Contact — The Minotaur](../campaign/first-contact-the-minotaur.md)** (the "yes" is that he *eats*). Afterward, freedom becomes concrete in **[Khaeros at the Keep — Safe Conduct](../campaign/the-minotaur-at-the-keep.md):** Valerian names him a free traveler, and Khaeros likely takes one Guild caravan contract toward Specularum before deciding whether to remain or return to Thyatis.
...
- **The head cleric — [Vesna, the Hierophant](../characters/the-hierophant.md) — suicide-ascends** rather than be taken (a 6th+ Entropy cleric returns undead unless the corpse is blessed), so the *truth* surfaces through the **body, the symbols, and [Mara Sokol, the newest recruit](../characters/mara-sokol.md),** not interrogation. A Traladaran patriot who serves the Baron they hate and dies thinking they're the hero; beside them, a former chapel novice only eleven days inside the Shrine whom the party might still pull back. Salt the temple with evidence the party carries out without understanding.
...
- **Optional playable proof:** [The Food Convoy](../campaign/the-food-convoy.md) puts six wagons on the ravine floor and brings the cave communities into the open. It can reveal the undead famine engine before the Shrine, serve as a sabotage target during the conflict, or become the public payoff afterward. One delivery interrupts hunger; it does not settle the permanent relationship.
...
- **The lizardfolk of the swamp** — *decided:* a specialized, reptilian offshoot of **kobold**, led by the matriarch **[Sessrik](../characters/faction-leaders.md#lizardfolk-leader--sessrik-the-marsh-matriarch)** (kin to [Yiznak's](../characters/faction-leaders.md#kobold-chief--yiznak-the-deepwright) kobolds). The **sovereignty case**: well-fed, self-sufficient, *not* part of the road problem — they want only recognition of their marsh. Valerian frames the [necklace incident](../campaign/the-lizardfolk-of-the-marsh.md) as a kill-quest, but it was a **misread passage toll**. The necklace can be traded back for cordage, fishing nets, and ceramic jugs; recognized traders owe no tribute. Live route: [Southern Forest and Northern Fens](../locations/southern_forest/index.md).
- **The human raiders / [bandit camp](../campaign/the-bandit-camp.md)** — *decided:* twelve misfits starving under the same manufactured famine as the caves, led by **Aldric Venn**, the ex-Barony sergeant who *lost Khaeros.* The **thesis in reverse** — humans doing what the caves are blamed for, labeled "bandits" not "monsters" — plus a buried conspiracy node. Aldric will talk but refuses to testify or trust ducal justice; if spared, the band leaves forever. Their departure also allows undead activity south of the road to increase. Live route: [Southern Forest and Northern Fens](../locations/southern_forest/index.md).
...
## Open decisions (yours to make — flagged seams)

The places where the rails are tight, a thread is thin, or a load-bearing fact is still undecided:

1. **The hobgoblin cannibalism.** ✓ *Decided:* famine-driven but institutionalized. Food and live-prisoner exchange can end it, but terms must prevent replacement captives and let Karrgan present the change as successful command. Full play: [Faction Negotiations](../campaign/faction-negotiations.md#karrgans-hobgoblingoblin-bloc); economic logic: [Captivity & Hunger](../campaign/captivity-and-hunger.md).
...
- Named individuals awaiting your notes: **Brundt the ogre**, **Khaeros the minotaur.** Conspiracy figures still off-page: **Bargle**, the **Black Eagle Baron.** Political NPC needing a profile: **the Castellan.**
- Keep the spine short and the approaches wide. The leeway is the point; the two hard "no" controls (bugbears, the Shrine) exist precisely so the leeway elsewhere means something.
