...
- **The head cleric — [Vesna, the Hierophant](../characters/the-hierophant.md) — suicide-ascends** rather than be taken (a 6th+ Entropy cleric returns undead unless the corpse is blessed), so the *truth* surfaces through the **body, the symbols, and the newest recruit,** not interrogation. A Traladaran patriot who serves the Baron they hate and dies thinking they're the hero. Salt the temple with evidence the party carries out without understanding.
