...
- **The lizardfolk of the swamp** — *decided:* a specialized, reptilian offshoot of **kobold**, led by the matriarch **[Sessrik](../characters/faction-leaders.md#lizardfolk-leader--sessrik-the-marsh-matriarch)** (kin to [Yiznak's](../characters/faction-leaders.md#kobold-chief--yiznak-the-deepwright) kobolds). The **sovereignty case**: well-fed, self-sufficient, *not* part of the road problem — they want only recognition of their marsh. Valerian frames the [necklace incident](../campaign/the-lizardfolk-of-the-marsh.md) as a kill-quest, but it was a **misread passage toll**, making it the **thesis in miniature**: solve it his way (kill) or the Duke's way (trade the necklace back and open the first border-market). Full faction: [The Lizardfolk of the Marsh](../campaign/the-lizardfolk-of-the-marsh.md).
- **The human raiders / [bandit camp](../campaign/the-bandit-camp.md)** — *decided:* twelve misfits starving under the same manufactured famine as the caves, led by **Aldric Venn**, the ex-Barony sergeant who *lost Khaeros.* The **thesis in reverse** — humans doing what the caves are blamed for, labeled "bandits" not "monsters" — plus a buried conspiracy node and the human integration case (displacement one stage further than the freed prisoners). Reachable, with a vicious control-group minority who aren't.
